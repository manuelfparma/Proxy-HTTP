...
PROXY_OBJECTS = src/proxy.o src/pcampserver.o src/http_parser.o src/proxyutils.o src/logger.o src/connection.o src/buffer.o src/dohclient.o src/dohparser.o src/dohsender.o src/dohutils.o src/proxyargs.o src/netutils.o
PCAMP_CLIENT_OBJECTS = src/pcampclient.o src/pcampargs.o src/netutils.o src/logger.o
