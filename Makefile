...
mccabe_complexity: 
	pmccabe $(SOURCES_PROXY) $(SOURCES_PARSER) $(SOURCES_PARSER_POP3) $(SOURCES_PARSER_POP3_RESPONSE) $(SOURCES_PCAMP_CLIENT) $(SOURCES_PCAMP_SERVER) $(SOURCES_PCAMP_UTILS)$(SOURCES_PCAMP_ARGS) $(SOURCES_PROXY_UTILS) $(SOURCES_NET_UTILS)$(SOURCES_LOGGER) $(SOURCES_CONNECTION) $(SOURCES_BUFFER) $(SOURCES_DOH_CLIENT) $(SOURCES_DOH_UTILS) $(SOURCES_DOH_SENDER) $(SOURCES_DOH_PARSER) $(SOURCES_ARGS)

clean:
	rm -rf httpd httpdctl src/*.o
